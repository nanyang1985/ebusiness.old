...
CHOICE_SKILL_TIME = ((0, "未経験者可"),
                     (1, "１年以上"),
                     (2, "２年以上"),
                     (3, "３年以上"),
                     (5, "５年以上"),
                     (10, "１０年以上"))
CHOICE_DEGREE_TYPE = ((1, "小・中学校"),
                      (2, "高等学校"),
                      (3, "専門学校"),
                      (4, "高等専門学校"),
                      (5, "短期大学"),
                      (6, "大学学部"),
                      (7, "大学大学院"))
CHOICE_SALESPERSON_TYPE = ((0, "営業部長"),
                           (1, "その他"),
                           (5, "営業担当"),
                           (6, "取締役"),
                           (7, "代表取締役社長"))
CHOICE_CLIENT_MEMBER_TYPE = (('01', "代表取締役社長"),
                             ('02', "取締役"),
                             ('03', "営業"),
                             ('99', "その他"))
CHOICE_MEMBER_TYPE = ((1, "正社員"),
                      (2, "契約社員"),
                      (3, "個人事業者"),
                      (4, "他社技術者"),
                      (5, "パート"),
...
CHOICE_POSITION = ((3, "事業部長"),
                   ...
                   (11, "勤務統計者"))
CHOICE_SEX = (('1', "男"), ('2', "女"))
CHOICE_SEX_EBOA = (('1', "男"), ('0', "女"))
CHOICE_MARRIED = (('', "------"), ('0', "未婚"), ('1', "既婚"))
CHOICE_PAYMENT_MONTH = (('1', "翌月"),
                        ('2', "翌々月"),
                        ('3', "３月"),
                        ('4', "４月"),
                        ('5', "５月"),
                        ('6', "６月"))
CHOICE_PAYMENT_DAY = (('01', '1日'),
                      ('02', '2日'),
                      ('03', '3日'),
                      ('04', '4日'),
                      ('05', '5日'),
                      ...
                      ('30', '30日'),
                      ('99', '月末'))
CHOICE_ATTENDANCE_YEAR = (('2014', "2014年"),
                          ('2015', "2015年"),
                          ('2016', "2016年"),
                          ('2017', "2017年"),
                          ('2018', "2018年"),
...
CHOICE_ACCOUNT_TYPE = (("1", "普通預金"),
                       ...
                       ("6", "大口定期預金"),
                       ("7", "積立定期預金"))
CHOICE_ATTENDANCE_TYPE = (('1', "１５分ごと"),
                          ('2', "３０分ごと"),
                          ('3', "１時間ごと"))
CHOICE_TAX_RATE = ((Decimal('0.00'), "税なし"),
                   (Decimal('0.05'), "5％"),
                   (Decimal('0.08'), "8％"))
CHOICE_DECIMAL_TYPE = (('0', "四捨五入"),
                       ('1', "切り捨て"))
CHOICE_DEV_LOCATION = (('01', "東大島"),
                       ('02', "田町"),
                       ('03', "府中"),
                       ('04', "西葛西"),
                       ('05', "中目黒"))
CHOICE_NOTIFY_TYPE = ((1, "EBのメールアドレス"),
                      (2, "個人メールアドレス"),
                      (3, "EBと個人両方のメールアドレス"))
CHOICE_ISSUE_STATUS = (('1', "起票"),
                       ('2', "対応中"),
                       ('3', "対応完了"),
                       ('4', "クローズ"),
                       ('5', "取下げ"))
CHOICE_ISSUE_LEVEL = ((1, "低"),
                      (2, "中"),
                      (3, "高"),
                      (4, "至急"),
                      (5, "大至急"))
...
CHOICE_ORG_TYPE = (('', '--------'),
                   ...
                   ('02', "部署"),
                   ('03', "課・グループ"))
CHOICE_WORKFLOW_OPERATION = (('01', "項目値変更"),
                             ('02', "レコード追加"))
CHOICE_BUSINESS_TYPE = (('01', "業務の種類（プログラマー）"),
                        ('02', "業務の種類（シニアプログラマー）"),
                        ('03', "業務の種類（システムエンジニア）"),
                        ...
                        ('16', "その他"))
CHOICE_CONTRACT_STATUS = (('01', "登録済み"),
                          ('02', "承認待ち"),
                          ('03', "承認済み"),
                          ('04', "廃棄"),
                          ('05', "自動更新"))
CHOICE_RECIPIENT_TYPE = (('01', "宛先"),
                         ('02', "ＣＣ"),
                         ('03', "ＢＣＣ"))
CHOICE_MEMBER_RANK = (('01', "グループ長"),
                      ('02', "副グループ長"),
                      ('11', "PM"),
                      ('21', "PL1"),
                      ('22', "PL2"),
...
CHOICE_CALCULATE_TYPE = (('01', '固定１６０時間'),
                         ('02', '営業日数 × ８'),
                         ('03', '営業日数 × ７.９'),
                         ('99', "その他（任意）"),
                         )
CHOICE_ENDOWMENT_INSURANCE = (('1', "加入する"),
                              ('0', "加入しない"))
