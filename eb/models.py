...
class Member(AbstractMember):
    ...
    id_card_expired_date = models.DateTimeField(blank=True, null=True, verbose_name=u"在留カード期限")
    visa_start_date = models.DateTimeField(blank=True, null=True, verbose_name=u"ビザ有効期限（開始）")
    visa_expire_date = models.DateTimeField(blank=True, null=True, verbose_name=u"ビザ有効期限（終了）")
